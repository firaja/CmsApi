...
insert into Article (id, title, content, creation_date, user_id, category, rating_Value, rating_Count) values (-1, 'Article1 title', 'Article 1 content',NOW(), -1,-1,1,2);
insert into Article (id, title, content, creation_date, user_id, category, rating_Value, rating_Count) values (-2, 'Article2 title', 'Article 1 content',NOW(), -1,-1,4,3);
insert into Article (id, title, content, creation_date, user_id, category, rating_Value, rating_Count) values (-3, 'Article3 title', 'Article 1 content',NOW(), -1,-1,3,4);
